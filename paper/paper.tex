...
\begin{array}{rcll}
	...
	\\
	A	& \in		& \text{Addresses} \\
	A	& ::=		& \adrr{R}{I}   \sep   \adrep{E}{P}{I}   \sep \adrop{O}{P}{I}   \sep   \adrs{S}{I}   \sep   \adrx{X}{I}   \\
\end{array}
\]
%
...
\begin{itemize}
\item $\runnable{\adrr{R}{I}}{TODOK}{T}{\Act}{N}$  \newline
...
$$
\begin{array}{c}
	\runnable{\adrr{R}{I}}{TODO}{0.0}{\Act}{0}
\end{array}
$$
...
$$
	\Tconnect{\adrep{E}{$U_1$}{$I_1$}}{\adrep{E}{$U_2$}{$I_2$}} \;\;\text{for all elements $E$ of port $U_2$}
$$
...
$$
	\Tconnect{\adrop{O}{$U_1$}{$I_1$}}{\adrop{O}{$U_2$}{$I_2$}} \;\;\text{for all operations $O$ of port $U_1$}
$$
