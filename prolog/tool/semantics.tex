...
%**TODO: convert some of the below to macros - erase the rest
\newcommand{\Tasync}                          {async}
\newcommand{\Tasyncresult}                    {async\_result}
\newcommand{\Tcall}                           {call}
\newcommand{\TcanBeInvokedConcurrently}       {canBeInvokedConcurrently}
\newcommand{\Tconnect}                        {connect}
\newcommand{\TdataReceived}                   {dataReceived}
\newcommand{\Tdelem}                          {delem}
\newcommand{\Tenter}                          {enter}
\newcommand{\Teps}                            {eps}
\newcommand{\Tequal}                          {equal}
\newcommand{\Tevents}                         {events}
\newcommand{\Texit}                           {exit}
\newcommand{\Tfalse}                          {false}
\newcommand{\Tidle}                           {idle}
\newcommand{\Tinv}                            {inv}
\newcommand{\Tinvalid}                        {invalid}
\newcommand{\Tlength}                         {length}
\newcommand{\Tless}                           {less}
\newcommand{\Tlesseq}                         {lesseq}
\newcommand{\Tlimit}                          {limit}
\newcommand{\Tmember}                         {member}
\newcommand{\TminimumStartInterval}           {minimumStartInterval}
\newcommand{\Tminus}                          {minus}
\newcommand{\Tnew}                            {new}
\newcommand{\Tnil}                            {nil}
\newcommand{\Tnodata}                         {no\_data}
\newcommand{\Tnull}                           {null}
\newcommand{\To}                              {o}
\newcommand{\Tok}                             {ok}
\newcommand{\Top}                             {op}
\newcommand{\ToperationInvoked}               {operationInvoked}
\newcommand{\Topres}                          {opres}
\newcommand{\Tpending}                        {pending}
...
\newcommand{\Ttaken}                          {taken}
\newcommand{\Tterm}                           {term}
\newcommand{\Ttick}                           {tick}
\newcommand{\Ttimer}                          {timer}
\newcommand{\Ttiming}                         {timing}
\newcommand{\Ttrue}                           {true}
\newcommand{\Tup}                             {up}
\newcommand{\Tvoid}                           {void}
\newcommand{\Twr}                             {wr}
