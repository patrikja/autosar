...
\subsection{Inter-runnable variables}
\begin{align}      \InterrunnableVariables  \notag \end{align}

\subsection{Exclusive areas}
\begin{align}      \ExclusiveAreas          \notag \end{align}

\subsection{Unbuffered sending/receiving}
\begin{align}      \ReadingWriting          \notag \end{align}

\subsection{Buffered sending/receiving}
\begin{align}      \SendingReceiving        \notag \end{align}

\subsection{Calling a server}

\renewcommand\Pcomma{\nonumber \;\text{and}\;}

\begin{align}      \CallServer              \notag \end{align}

\renewcommand\Pcomma{\nonumber \\&\text{and}\;\;}

\subsection{Passing back a server result}
\begin{align}      \ServerResult            \notag \end{align}

\subsection{Spawning and terminating}
\begin{align}      \SpawnTerminate          \notag \end{align}

\subsection{Passing time}
\begin{align}      \PassingTime             \notag \end{align}

%\renewcommand{\Prule}[2]{#1 & \Pif \;\; #2\\}
%**TODO: check page-break
\newpage
\subsection{Ignoring broadcasts}
\begin{align}      \IgnoreBroadcast         \notag \end{align}
