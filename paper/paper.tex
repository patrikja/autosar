...
%TODO: replace varibles with \V{Variable} (to make sure the style matches the semantic rules in the appendix - lower case variables, for example)
...
Countdown timer with period \V{T_p} for runnable $R$ of component $I$ with $T$ seconds left of its current cycle.
\end{itemize}
...
%TODO: fix the alignment of p2, q1
...
%TODO: make the parallell composition more visible
